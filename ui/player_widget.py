...
class PlayerWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._set_start_btn = QPushButton("Inizia da qui")
        ...
        for btn in (
            ...
            self._configure_transport_button(btn)
        ...
        self._volume.setMinimumWidth(72)

        self._volume.setMaximumWidth(120)

        self._volume.setFixedHeight(22)
    ...
    def _configure_transport_button(button: QPushButton) -> None:

        """Impedisce la compressione verticale del testo nei pulsanti transport."""

        button.setMinimumHeight(_PLAYER_BTN_MIN_HEIGHT)
    ...
    def set_start_save_enabled(self, enabled: bool) -> None:
        ...
        """Abilita il pulsante 'Inizia da qui' (solo per brani locali)."""
